...
exports.pickACard = async(gameId, playerId, choice) => {
    try {
        ...
        if(!game) return { successs: false, message: 'The Game is either completed or is invalid'}
        
        // check if valid player is making move
        if(game.turn !== playerId) return { successs: false, message: 'Invalid player or turn'}
